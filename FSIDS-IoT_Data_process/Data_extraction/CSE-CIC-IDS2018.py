...
path = 'F:/GraduateStudy/DataSet/archive(CSE-CIC-IDS2018)/'

csv_data = pd.read_csv(path+'03-02-2018.csv')  # 读取数据
...
path1 = 'F:/GraduateStudy/DataSet/!A-IDSFS/CSE-CIC-IDS2018/03-02_'
