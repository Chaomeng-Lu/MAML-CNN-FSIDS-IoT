...
class MAML:
	...
	def forward(self, x, weights, training):
		...
		# print('flatten1:', hidden1.get_shape())
		# print('flatten2:', hidden2.get_shape())
		# print('flatten3:', hidden3.get_shape())
		# print('flatten4:', hidden4.get_shape())
		# flatten layer
		hidden4 = tf.reshape(hidden4, [-1, np.prod([int(dim) for dim in hidden4.get_shape()[1:]])], name='reshape2')

		# print('flatten4-r:', hidden4.get_shape())
		# sys.exit(0)
